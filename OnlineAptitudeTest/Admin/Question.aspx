<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeFile="Question.aspx.cs" Inherits="OnlineAptitudeTest.Admin.Question" %>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group bg-warning">
                <asp:Button ID="btn_panelAllQuestion" runat="server" Text="All Question" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" BackColor="#000222" />
            </div>
        </div>
