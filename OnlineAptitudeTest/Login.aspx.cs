    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btn_login_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("spCandidateLogin", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@candidate_email", txt_email.Text);
                    ...
                    try
                    {
                        ...
                        if (value == 1)
                        {
                            ...
                            {
                                HttpCookie user = new HttpCookie("candidate_cookies"); //creating cookie object where user_cookies is cookie name
                                user["candidateemail"] = txt_email.Text; // cookie content
                            ...
                            {
                                Session["candidateemail"] = txt_email.Text;
                            }
